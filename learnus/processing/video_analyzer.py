        ...
        while True:
            ...
            if previous_frame is not None:
                ...
                if similarity < self.change_threshold:
                    ...
                    print(f"  [OK] Frame change at {current_time:.2f}s (similarity: {similarity:.3f})")
            
            previous_frame = gray
        
        cap.release()
        print(f"[OK] Detected {len(change_timestamps)} frame changes (checked {samples_checked} samples)")
